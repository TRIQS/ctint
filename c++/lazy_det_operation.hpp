...
namespace triqs_ctint {
  ...
  class lazy_det_operation_t {
    ...
    lazy_det_operation_t &operator<<(vertex_t const &v) {
      ...
      lazy_op_lst[v.idx.b1].lazy_add_cdag(cdag_t{v.tau1, v.idx.i1, v.has_alpha_shift, v.s}); //c^\dagger
      lazy_op_lst[v.idx.b2].lazy_add_c(c_t{v.tau2, v.idx.i2, v.has_alpha_shift, v.s}); //c
      lazy_op_lst[v.idx.b3].lazy_add_cdag(cdag_t{v.tau3, v.idx.i3, v.has_alpha_shift, v.s}); //c^\dagger
      lazy_op_lst[v.idx.b4].lazy_add_c(c_t{v.tau4, v.idx.i4, v.has_alpha_shift, v.s}); //c
      return *this;
    }
