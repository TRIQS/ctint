...
namespace triqs_ctint {
  ...
  void solver_core::solve(solve_params_t const &solve_params) {
    ...
    if (params.measure_sign_only){
      ...
      if (params.measure_G2_fluct_diag_tau) mc.add_measure(measures::G2_fluct_diag_tau{params, qmc_config, &result_set()}, "G2_fluct_diag_tau measure");
      if (params.measure_G2_fluct_diag_omega_tau) mc.add_measure(measures::G2_fluct_diag_omega_tau{params, qmc_config, &result_set()}, "G2_fluct_diag_omega_tau measure");
    }
