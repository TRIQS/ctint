...
namespace triqs_ctint {
  ...
  void solver_core::solve(solve_params_t const &solve_params) {
    ...
    if (params.measure_sign_only) {
      ...
      if (params.measure_f4pp_loc_iw)
        mc.add_measure(measures::f4pp_loc_iw{params, qmc_config, &result_set(), GinvG0_iw, G0Ginv_iw}, "f4pp_loc_iw measure");
      if (params.measure_f4ph_loc_iw)
        mc.add_measure(measures::f4ph_loc_iw{params, qmc_config, &result_set(), GinvG0_iw, G0Ginv_iw}, "f4ph_loc_iw measure");
  ...
  void solver_core::post_process(params_t const &p) {
    ...
    if (f4pp_loc_iw and M_iw) Fpp_loc_iw = Fpp_loc_from_f4pp_loc(f4pp_loc_iw.value(), M_iw.value(), GinvG0_iw, G0Ginv_iw);
    if (f4ph_loc_iw and M_iw) Fph_loc_iw = Fph_loc_from_f4ph_loc(f4ph_loc_iw.value(), M_iw.value(), GinvG0_iw, G0Ginv_iw);
