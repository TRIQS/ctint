...
namespace triqs_ctint {
  ...
  template <Chan_t Chan> chi2_tau_t M2_from_M3(chi3_tau_t M3_tau, g_tau_cv_t G0_tau, int n_tau_M2) {
  ...
  inline chi2_tau_t M2_from_M3_PP(chi3_tau_t M3_tau, g_tau_cv_t G0_tau, int n_tau_M2) { return M2_from_M3<Chan_t::PP>(M3_tau, G0_tau, n_tau_M2); }
  inline chi2_tau_t M2_from_M3_PH(chi3_tau_t M3_tau, g_tau_cv_t G0_tau, int n_tau_M2) { return M2_from_M3<Chan_t::PH>(M3_tau, G0_tau, n_tau_M2); }
