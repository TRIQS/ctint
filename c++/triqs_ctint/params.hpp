...
namespace triqs_ctint {
  ...
  struct solve_params_t {
    ...
    /// Length of a MC cycle (0: automatically determined from autocorrelation time)
    int length_cycle = 0;
    ...
    /// Number of warmup cycles (0: automatic convergence detection)
    ...
    /// Measure the full density matrix by operator insertion (needed for chi3)
