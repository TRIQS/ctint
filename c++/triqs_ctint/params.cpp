...
namespace triqs_ctint {
  ...
  void h5_write(h5::group h5group, std::string subgroup_name, solve_params_t const &sp) {
    ...
    h5_write(grp, "n_iW_M3", sp.n_iW_M3);
    h5_write(grp, "dlr2d_compress_grid", sp.dlr2d_compress_grid);
  ...
  void h5_read(h5::group h5group, std::string subgroup_name, solve_params_t &sp) {
    ...
    h5::try_read(grp, "use_auxiliary_spin_flip", sp.use_auxiliary_spin_flip);
    ...
    h5::try_read(grp, "measure_density_matrix", sp.measure_density_matrix);
    ...
    h5_read(grp, "n_iW_M3", sp.n_iW_M3);
    h5::try_read(grp, "dlr2d_compress_grid", sp.dlr2d_compress_grid);
