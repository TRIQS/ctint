...
namespace triqs_ctint::measures {
  ...
  // Same accumulation as iw4_accumulate, over the pp mesh (iW, iw, iwp):
  //
  //   M4(i,j,k,l) += sign * M1a(j,i) * M2a(l,k) - sign * M1b(l,i) * M2b(j,k)   [second term bl1 == bl2 only]
  //
  // Defined in M4pp_iw.cpp, declared here so benchmarks/iw_accum/iw4.cpp can drive it per block size.
  void iw4pp_accumulate(mc_weight_t sign, M4_M_t const &M, chi4_iw_v_t &M4pp, int bl1, int bl2, long bl2_size) noexcept;
