...
namespace triqs_ctint::measures {
  struct f4pp_loc_iw {
    ...
    f4pp_loc_iw(f4pp_loc_iw &&)                 = default;
    ~f4pp_loc_iw()                              = default;
    f4pp_loc_iw &operator=(f4pp_loc_iw const &) = delete;
    f4pp_loc_iw &operator=(f4pp_loc_iw &&)      = delete;
    ...
    block2_gf_view<prod<imfreq, imfreq, imfreq>, tensor_valued<1>> f4pp_loc_iw_;
