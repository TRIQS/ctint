        ...
        for (auto iw1 : iw_mesh) {
          for (auto iw2 : iw_mesh) {
            for (auto iw3 : iw_mesh) {
              ...
              if (equal_sizes) {
                process_vectorized_loop<true>(sign, bl1_size, bl2_size, M1_view_val, M1_view_if, M2_view, M2_view_if, M4_view);
              } else {
                process_vectorized_loop<false>(sign, bl1_size, bl2_size, M1_view_val, M1_view_if, M2_view, M2_view_if, M4_view);
              }
            }
          }
        }
