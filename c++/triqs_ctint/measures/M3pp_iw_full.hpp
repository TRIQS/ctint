...
namespace triqs_ctint::measures {
  ...
  */
  struct M3pp_iw_full {
    ...
    M3pp_iw_full(params_t const &params_, qmc_config_t const &qmc_config_, container_set *results, g_tau_cv_t G0_tau_);

    // M3pp_iw_full needs to be uncopyable due to nfft::buffer_t
    M3pp_iw_full(M3pp_iw_full const &)            = delete;
    M3pp_iw_full(M3pp_iw_full &&)                 = default;
    ~M3pp_iw_full()                               = default;
    M3pp_iw_full &operator=(M3pp_iw_full const &) = delete;
    M3pp_iw_full &operator=(M3pp_iw_full &&)      = delete;
