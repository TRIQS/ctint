...
c.add_member(c_name = "Fpp_loc_iw",
             c_type = "std::optional<chi4_loc_iw_t>",
             read_only= True,
             doc = r"""The local two-particle vertex function (pp channel)""")

c.add_member(c_name = "Fph_loc_iw",
             c_type = "std::optional<chi4_loc_iw_t>",
             read_only= True,
             doc = r"""The local two-particle vertex function (ph channel)""")
...
c.add_member(c_name = "G_iw",
             c_type = "g_iw_t",
             read_only= True,
             doc = r"""Green function in Matsubara frequencies (Eq. (18) in Notes). Dependent on M_iw""")

c.add_member(c_name = "GinvG0_iw",
             c_type = "g_iw_t",
             read_only= True,
             doc = r"""Buffers for local vertex measurement""")

c.add_member(c_name = "G0Ginv_iw",
             c_type = "g_iw_t",
             read_only= True,
             doc = r"""""")
