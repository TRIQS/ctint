...
c.add_member(c_name = "G2_fluct_diag_tau",
             c_type = "std::optional<chi2_tau_t>",
             read_only= True,
             doc = r"""The equal time correlator $G2_fluct_diag_tau$ in the particle-hole channel in imaginary times as obtained by operator insertion""")

c.add_member(c_name = "G2_fluct_diag_omega_tau",
             c_type = "std::optional<chi3_tau_t>",
             read_only= True,
             doc = r"""The equal time correlator $G2_fluct_diag_omega_tau$ in the particle-hole channel in imaginary times as obtained by operator insertion""")
...
c.add_constructor("""(**triqs_ctint::constr_params_t)""", doc = r"""Construct a CTINT solver
...
c.add_member(c_name = "measure_G2_fluct_diag_tau",
             c_type = "bool",
             initializer = """ false """,
             doc = r"""Measure of G2_fluct_diag_tau by insertion""")

c.add_member(c_name = "n_tau_G2_fluct_diag",
             c_type = "int",
             initializer = """ 201 """,
             doc = r"""Number of imaginary time points in G2_fluct_diag""")

c.add_member(c_name = "measure_G2_fluct_diag_omega_tau",
             c_type = "bool",
             initializer = """ false """,
             doc = r"""Measure of G2_fluct_diag_omega_tau by insertion""")

c.add_member(c_name = "n_tau_G2_fluct_diag_omega",
             c_type = "int",
             initializer = """ 201 """,
             doc = r"""Number of imaginary time points in G2_fluct_diag_omega""")
