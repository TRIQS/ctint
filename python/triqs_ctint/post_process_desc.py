...
module.add_function ("chi4_loc_iw_t triqs_ctint::Fpp_loc_from_f4pp_loc (chi4_loc_iw_t::view_type f4pp_loc_iw, g_iw_t::view_type M_iw, g_iw_t::view_type GinvG0_iw, g_iw_t::view_type G0Ginv_iw)", doc = r"""Calculate the vertex function :math:`Fpp_loc` from f4pp_loc, M_iw and Ginv * G0 / G0 * Ginv""")

module.add_function ("chi4_loc_iw_t triqs_ctint::Fph_loc_from_f4ph_loc (chi4_loc_iw_t::view_type f4ph_loc_iw, g_iw_t::view_type M_iw, g_iw_t::view_type GinvG0_iw, g_iw_t::view_type G0Ginv_iw)", doc = r"""Calculate the vertex function :math:`Fph_loc` from f4ph_loc, M_iw and Ginv * G0 / G0 * Ginv""")
...
module.add_function ("chi4_iw_t triqs_ctint::chi_tilde_ph_from_G2c (chi4_iw_t::view_type G2c_iw, g_iw_cv_t G_iw, gf_struct_t gf_struct, int n_iW, int n_iw)", doc = r"""Calculate the generalized ph susceptibility from G2c_iw and G_iw""")
