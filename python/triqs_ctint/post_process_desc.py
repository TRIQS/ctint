...
module.add_function ("triqs_ctint::chi3_iw_t triqs_ctint::chi3_from_M3_PP (triqs_ctint::chi3_iw_cv_t M3_iw, triqs_ctint::g_iw_cv_t M_iw, triqs_ctint::g_iw_cv_t G0_iw)", doc = """""")

module.add_function ("triqs_ctint::chi3_iw_t triqs_ctint::chi3_from_M3_PH (triqs_ctint::chi3_iw_cv_t M3_iw, triqs_ctint::g_iw_cv_t M_iw, triqs_ctint::g_iw_cv_t G0_iw)", doc = """""")

module.add_function ("triqs_ctint::chi2_tau_t triqs_ctint::chi2_from_M2_PP (triqs_ctint::chi2_tau_cv_t M2_tau, triqs_ctint::g_iw_cv_t M_iw, triqs_ctint::g_iw_cv_t G0_iw, std::vector<matrix<M_tau_scalar_t>> M_hartree)", doc = """""")

module.add_function ("triqs_ctint::chi2_tau_t triqs_ctint::chi2_from_M2_PH (triqs_ctint::chi2_tau_cv_t M2_tau, triqs_ctint::g_iw_cv_t M_iw, triqs_ctint::g_iw_cv_t G0_iw, std::vector<matrix<M_tau_scalar_t>> M_hartree)", doc = """""")
